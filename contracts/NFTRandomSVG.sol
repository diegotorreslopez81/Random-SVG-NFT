...
contract CharacterRandomGenerator is ERC721URIStorage {
  ...
  function CreateRandonCharacterNFT(string calldata data) public {
    ...
    string memory json = Base64.encode(
        bytes(
            string(
                abi.encodePacked(
                    '{"name":"RandCharacter NFT", "image":"',
                    imageStr,
                    unicode'", "description": "This NFT is randomly generated by RandCharacter NFT."}'
                )
            )
        )
    );
